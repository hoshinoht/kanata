...
async fn client_models_are_authenticated_and_permission_filtered() {
    ...
    assert_eq!(
        to_bytes(response.into_body(), usize::MAX)
            .await
            .expect("body"),
        "{\"data\":[{\"created\":0,\"id\":\"local-chat\",\"kanata\":{\"function_tools\":true,\"input_audio\":false,\"operations\":[\"chat\"],\"reasoning_control\":false,\"reasoning_efforts\":null,\"sampling_controls\":false,\"streaming\":true,\"structured_output\":false,\"trust_zone\":\"local\"},\"object\":\"model\",\"owned_by\":\"kanata\"}],\"object\":\"list\"}"
    );
}
